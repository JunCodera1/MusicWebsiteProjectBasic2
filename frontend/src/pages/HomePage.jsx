...
const spotifyPlaylistData = [{ title: "Peaceful Piano", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Huy", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Tien", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Thuan", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Hoa", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image }];
;
const focusCardData = [{ title: "Peaceful Piano", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Huy", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Tien", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Thuan", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image },
{ title: "Hoa", description: "lorem ipsum dolor sit amet consectetur", imgUrl: image }];
...
const PlaylistView = ({ titleText, cardsData }) => {
  return (
    <div className="text-white mt-8" style={{ marginLeft: "20px", marginTop: "20px" }}>
...
const HomePage = () => {
  ...
  return (
    <Box style={{ display: "flex", minHeight: "100vh", position: "relative", minHeight: "100vh" }}>
      <Sidebar />
      <div className="content p-0 pt-0 overflow-auto flex-1" style={{ overflowY: "auto", height: "100vh", position: "relative" }}>
        <PlaylistView titleText={"Chit Chit"} cardsData={focusCardData} />
        <PlaylistView titleText={"Chit Manh Hon"} cardsData={spotifyPlaylistData} />
